...
import helmiHelsinki1 from './media/images/helmiHelsinki1.png';
import helmiHelsinki2 from './media/images/helmiHelsinki2.png';
import helmiHelsinki3 from './media/images/helmiHelsinki3.png';
...
export const projectsInfo = [
...

    {
...

        {
            ...
            'https://img.icons8.com/ios/344/css.png',
            'https://img.icons8.com/color/344/bootstrap.png',
            'https://img.icons8.com/color/344/nodejs.png',
            'https://img.icons8.com/color/344/mongodb.png',
            'https://img.icons8.com/ios-glyphs/344/github.png',
            'https://img.icons8.com/ios/344/heroku.png',
        ...
        },
        {
            ...
            images:[helmiHelsinki1, helmiHelsinki2, helmiHelsinki3],
            type: "professional",
            overview:
                'This was my first professional project. This web app was created for a finnish hairdressing salon. The costumer gave me full freedom for the design and functionallity of the website. There are 6 main functionallities: Services, Price list, Booking page, Meet us, contacts and the Gallery.',
            mainLessons:
                "This project marked a very important step in my career as a web developer, since it was my first project for a costumer. I had full freedom to develop the project, from de design to the functionality, with the costumer demanding only that it would be possible to book from the website. \nThis was good for me since it let me work on planning an entire app. How would it look? What would it do? How components would relate and connect between each other? I decided for a simple layout and give more highlights to the main functionalities, mainly the booking page. Also some dynamism in the page makes it look more intersting. \nThe costumer reaction to th website was very positive and I feel now I amon  my way to take my career to the next stage.",
            stackUsed: [
             phaser3,
            'https://img.icons8.com/color/2x/javascript.png',
            'https://img.icons8.com/ios/344/css.png',
