...
export const TopNav = () => {
    return(
        <Navbar collapseOnSelect expand="lg" bg="transparent" variant="dark" style={{fontSize: '1.2rem'}}>
            <Container>
                <Navbar.Brand><Image src={logo} id="logo"></Image></Navbar.Brand>
                <Navbar.Toggle />
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="justify-content-end" style={{ width: "100%" }}>
                        <LinkContainer to="/my-react-portfolio"><Nav.Link>Home</Nav.Link></LinkContainer> 
                        <LinkContainer to="/my-react-portfolio/about"><Nav.Link>About</Nav.Link></LinkContainer> 
                        <LinkContainer to="/my-react-portfolio/skills"><Nav.Link>Skills</Nav.Link></LinkContainer>
                        <LinkContainer to="/my-react-portfolio/projects"><Nav.Link>Projects</Nav.Link></LinkContainer>
                        <LinkContainer to="/my-react-portfolio/contacts"><Nav.Link>Contacts</Nav.Link></LinkContainer> 
